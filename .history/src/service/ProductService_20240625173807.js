export class ProductService {
    ...
    async buscarModelosPorMarca(marca) {
        const requestOptions = {
            method: 'GET',
            headers: {"content-type": "application/json"},
        };
        const response = await fetch(`http://localhost/revendaCarro/hmtl/src/controllers/BuscarModelos.php?marca_id=${{}}`, requestOptions);
        const data = await response.json();

    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                ...
                <div class="justify-center my-5 mr-5">
                    ...
                    <div class="field">
                        ...
                        <Dropdown class="border w-full" id="id" v-model="marcaSelecionada" :options="marcas" optionLabel="nome" placeholder="Selecione a Marca" @emit="marcaId=marcaSelecionada." />
                    </div>
                    <div class="field">

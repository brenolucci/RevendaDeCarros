...
function marcaEscolhida() {
    ...
    productService.buscarModelosPorMarca(marca).then((data) => (modelos.value = data));
}
    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                ...
                <div class="justify-center my-5 mr-5">
                    ...
                    <div class="field">
                        ...
                        <Dropdown class="border w-full" id="id" v-model="modeloSelecionado" :options="modelos" optionLabel="label" placeholder="Selecione o Modelo">
                            <template #value="slotProps">
                                <div v-if="slotProps.value && slotProps.value.value">
                                    <span :class="'product-badge status-' + slotProps.value.value">{{ slotProps.value.label }}</span>
                                </div>

    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                ...
                <div class="justify-center my-5 mr-5">
                    ...
                    <div class="field">
                        ...
                        <Dropdown class="border w-full" id="inventoryStatus" v-model="marcas.nome" :options="marcas.nome" optionLabel="label" placeholder="Selecione a Marca">
                            <template #value="marcas.nome">
                                <div v-if="marcas.nome && marcas.nome">
                                    <span :class="'product-badge status-' + marcas.nome">{{ marcas.nome }}</span>
                                </div>
                                <div v-else-if="marcas.nome && !marcas.nome">
                                    <span :class="'product-badge status-' + marcas.nome.toLowerCase()">{{ slotProps.value }}</span>
                                </div>
                                <span v-else>
                                    {{ slotProps.placeholder }}
                                </span>

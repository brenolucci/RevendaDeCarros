    ...
    <Dialog v-model:visible="productDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                ...
                <div class="justify-center my-5 mr-5">
                    ...
                    <div class="field">
                        ...
                        <Dropdown class="border w-full" id="marcas" v-model="marcaSelecionada" :options="marcas" optionLabel="nome" placeholder="Selecione a Marca" @change="marcaEscolhida" />
                    </div>
                    <div class="field">
                        <label for="inventoryStatus" class="mb-3">MODELO</label>
                        <Dropdown class="border w-full" id="modelos" v-model="modeloSelecionado" :options="modelos" optionLabel="nome" placeholder="Selecione o Modelo">
                        </Dropdown>
                    </div>
                    <img :src="'/demo/images/product/' + product.image" :alt="product.image" v-if="product.image" width="150" class="mt-0 mx-auto mb-5 block shadow-2" />
                    <div class="field">

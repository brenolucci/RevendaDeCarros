                        ...
                        <div class="border-1 surface-border border-round w-auto m-2 ">
                            <div class="mb-3">
                                <div class="relative mx-auto">
                                    <img :src="Skyline" :alt="product.data.name" class="w-full" />
                                    <Tag :value="product.data[0].inventoryStatus" :severity="getSeverity(slotProps.data.inventoryStatus)" class="absolute" style="left: 3px; top: 5px" />
                                </div>
                            </div>
                            <div class="p-3">
                                ...
                                <div class="justify-content-between align-items-center mb-2">
                                    ...
                                    <span class="flex justify-center">
                                        <Button class="mx-6 mt-4 mb-2">Fazer Orçamento</Button>
                                    </span>
                                    <hr/>
